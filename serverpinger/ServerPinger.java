...
import by.radioegor146.serverpinger.messages.EmptyMessage;
...
public class ServerPinger {
    ...
    private ConnectionAcceptOrDenyMessage serverInfo;
    ...
    private void handleMessage(byte type, byte[] data) throws IOException {
        switch (type) {
            case 3:
                ...
                .GetuestIDGeneratedOnServer = tmsg.connectionRequestIDGeneratedOnServer;
                sendMessage(message);
                break;
            case 5: 
                type = 5;
